prompt --application/shared_components/plugins/template_component/theme_101_media_list
begin
--   Manifest
--     PLUGIN: THEME_101$MEDIA_LIST
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(224609694604711248)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '101')
,p_name=>'THEME_101$MEDIA_LIST'
,p_display_name=>'Media List'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_101$MEDIA_LIST'),'')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2024627527476594896)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2024628082488594897)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224610378148711248)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224610697551711251)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224610932953711251)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224611269784711251)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224611561339711251)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224610932953711251)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2024628082488594897)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224611876940711251)
,p_plugin_attribute_id=>wwv_flow_imp.id(224611561339711251)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224612207372711251)
,p_plugin_attribute_id=>wwv_flow_imp.id(224611561339711251)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224612656229711251)
,p_plugin_attribute_id=>wwv_flow_imp.id(224611561339711251)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224613046872711251)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224611561339711251)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224613301864711252)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(224613046872711251)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224613638457711252)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224613913044711252)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224614280581711252)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224614508522711252)
,p_plugin_attribute_id=>wwv_flow_imp.id(224614280581711252)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224614974645711252)
,p_plugin_attribute_id=>wwv_flow_imp.id(224614280581711252)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224615326261711252)
,p_plugin_attribute_id=>wwv_flow_imp.id(224614280581711252)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224615754577711252)
,p_plugin_attribute_id=>wwv_flow_imp.id(224614280581711252)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224616115333711252)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(224611269784711251)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2024627527476594896)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224616429481711252)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224616711629711253)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224617093157711253)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224617379213711253)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224617619165711253)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224617991474711253)
,p_plugin_attribute_id=>wwv_flow_imp.id(224617619165711253)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224618342004711253)
,p_plugin_attribute_id=>wwv_flow_imp.id(224617619165711253)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224618726748711253)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224619043056711253)
,p_plugin_attribute_id=>wwv_flow_imp.id(224618726748711253)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224619481866711253)
,p_plugin_attribute_id=>wwv_flow_imp.id(224618726748711253)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224619880641711253)
,p_plugin_attribute_id=>wwv_flow_imp.id(224618726748711253)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224620276763711254)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224620501194711254)
,p_plugin_attribute_id=>wwv_flow_imp.id(224620276763711254)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224620925740711254)
,p_plugin_attribute_id=>wwv_flow_imp.id(224620276763711254)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224621384681711254)
,p_plugin_attribute_id=>wwv_flow_imp.id(224620276763711254)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224621700061711254)
,p_plugin_attribute_id=>wwv_flow_imp.id(224620276763711254)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224622175799711254)
,p_plugin_attribute_id=>wwv_flow_imp.id(224620276763711254)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224622594371711254)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224622818126711254)
,p_plugin_attribute_id=>wwv_flow_imp.id(224622594371711254)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224623291159711255)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2024831134645741525)
,p_plugin_id=>wwv_flow_imp.id(224609694604711248)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

prompt --application/shared_components/plugins/template_component/theme_101_comments
begin
--   Manifest
--     PLUGIN: THEME_101$COMMENTS
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(224577237899711225)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '101')
,p_name=>'THEME_101$COMMENTS'
,p_display_name=>'Comments'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_101$COMMENTS'),'')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2024462713684742943)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224577718616711227)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224578074931711227)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224578391265711227)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224578670094711227)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224578924642711228)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224583552251711230)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2024462713684742943)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224579208037711228)
,p_plugin_attribute_id=>wwv_flow_imp.id(224578924642711228)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224579631312711229)
,p_plugin_attribute_id=>wwv_flow_imp.id(224578924642711228)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224580078218711229)
,p_plugin_attribute_id=>wwv_flow_imp.id(224578924642711228)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224580487410711229)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224578924642711228)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224580797382711229)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(224580487410711229)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224581009689711229)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224581355613711229)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224581654553711229)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224581927661711229)
,p_plugin_attribute_id=>wwv_flow_imp.id(224581654553711229)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224582311644711229)
,p_plugin_attribute_id=>wwv_flow_imp.id(224581654553711229)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224582708026711229)
,p_plugin_attribute_id=>wwv_flow_imp.id(224581654553711229)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224583186452711230)
,p_plugin_attribute_id=>wwv_flow_imp.id(224581654553711229)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224583552251711230)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224583819401711230)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224584168898711230)
,p_plugin_attribute_id=>wwv_flow_imp.id(224583819401711230)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224584505304711230)
,p_plugin_attribute_id=>wwv_flow_imp.id(224583819401711230)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224584909339711231)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2024595381117844446)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2024594789612836989)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2024650413282818868)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2024802630995689639)
,p_plugin_id=>wwv_flow_imp.id(224577237899711225)

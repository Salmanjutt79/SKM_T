prompt --application/shared_components/plugins/template_component/theme_101_avatar
begin
--   Manifest
--     PLUGIN: THEME_101$AVATAR
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(224559734798711207)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '101')
,p_name=>'THEME_101$AVATAR'
,p_display_name=>'Avatar'
,p_supported_component_types=>'PARTIAL'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_101$AVATAR'),'')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224560019239711207)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224560388871711209)
,p_plugin_attribute_id=>wwv_flow_imp.id(224560019239711207)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224560742035711212)
,p_plugin_attribute_id=>wwv_flow_imp.id(224560019239711207)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224561162689711212)
,p_plugin_attribute_id=>wwv_flow_imp.id(224560019239711207)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224561580753711212)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224560019239711207)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224561805362711213)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224561580753711212)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224562130587711213)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224562416165711214)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224562762125711214)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224563088633711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224562762125711214)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224563419337711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224562762125711214)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224563886237711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224562762125711214)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224564259055711214)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224564502258711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224564935663711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224565331637711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224565720301711214)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224566168240711215)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224566528175711215)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224566972609711216)
,p_plugin_attribute_id=>wwv_flow_imp.id(224564259055711214)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224567370711711216)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2024610589736824959)
,p_plugin_id=>wwv_flow_imp.id(224559734798711207)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

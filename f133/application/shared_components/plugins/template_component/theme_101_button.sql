prompt --application/shared_components/plugins/template_component/theme_101_button
begin
--   Manifest
--     PLUGIN: THEME_101$BUTTON
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(224574527663711222)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '101')
,p_name=>'THEME_101$BUTTON'
,p_display_name=>'Button'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_101$BUTTON'),'')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224574829429711223)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224575101313711223)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224575486315711223)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224575750261711223)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224576010941711224)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224576361449711224)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224576611375711224)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224576994893711224)
,p_plugin_id=>wwv_flow_imp.id(224574527663711222)
,p_attribute_scope=>'COMPONENT'

prompt --application/shared_components/plugins/template_component/theme_101_content_row
begin
--   Manifest
--     PLUGIN: THEME_101$CONTENT_ROW
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(224587281260711233)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '101')
,p_name=>'THEME_101$CONTENT_ROW'
,p_display_name=>'Content Row'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_101$CONTENT_ROW'),'')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2151825084634782930)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2151824529622782929)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224587918032711236)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224588257094711236)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224588517361711236)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224588874039711236)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224589151823711236)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224589472684711236)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224589744450711237)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224589151823711236)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2151825084634782930)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224590019798711237)
,p_plugin_attribute_id=>wwv_flow_imp.id(224589744450711237)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224590448740711238)
,p_plugin_attribute_id=>wwv_flow_imp.id(224589744450711237)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224590894807711238)
,p_plugin_attribute_id=>wwv_flow_imp.id(224589744450711237)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224591286134711239)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(224589744450711237)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224591550478711239)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(224591286134711239)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224591842895711239)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224592121584711239)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224592477725711239)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224592746119711239)
,p_plugin_attribute_id=>wwv_flow_imp.id(224592477725711239)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224593112401711239)
,p_plugin_attribute_id=>wwv_flow_imp.id(224592477725711239)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224593569909711239)
,p_plugin_attribute_id=>wwv_flow_imp.id(224592477725711239)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224593928007711239)
,p_plugin_attribute_id=>wwv_flow_imp.id(224592477725711239)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224594351296711239)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(224589472684711236)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2151824529622782929)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224594688161711240)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224594979285711240)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224595258294711241)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224595526218711241)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224595832033711241)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224596120043711241)
,p_plugin_attribute_id=>wwv_flow_imp.id(224595832033711241)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224596599145711241)
,p_plugin_attribute_id=>wwv_flow_imp.id(224595832033711241)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224596928742711241)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224597276970711241)
,p_plugin_attribute_id=>wwv_flow_imp.id(224596928742711241)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224597652891711241)
,p_plugin_attribute_id=>wwv_flow_imp.id(224596928742711241)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224598008322711241)
,p_plugin_attribute_id=>wwv_flow_imp.id(224596928742711241)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224598417689711241)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224598744732711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224599197735711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224599569675711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224599923183711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224600386156711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224600778572711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224601177020711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224598417689711241)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224601589903711242)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224601886944711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224601589903711242)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224602247068711242)
,p_plugin_attribute_id=>wwv_flow_imp.id(224601589903711242)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224602656883711243)
,p_plugin_attribute_id=>wwv_flow_imp.id(224601589903711242)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224603034286711243)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224603366104711243)
,p_plugin_attribute_id=>wwv_flow_imp.id(224603034286711243)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224603786356711243)
,p_plugin_attribute_id=>wwv_flow_imp.id(224603034286711243)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224604101808711243)
,p_plugin_attribute_id=>wwv_flow_imp.id(224603034286711243)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(224604561183711243)
,p_plugin_attribute_id=>wwv_flow_imp.id(224603034286711243)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(224604924235711243)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2033038974850604544)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2033040234370608692)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2019445346176197811)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2020124646906280915)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2033037039783559558)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2033038373173573415)
,p_plugin_id=>wwv_flow_imp.id(224587281260711233)

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(224451291078711117)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225512465932730245)
,p_plug_template_id=>wwv_flow_imp.id(224451291078711117)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225512970693730245)
,p_plug_template_id=>wwv_flow_imp.id(224451291078711117)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225513426339730245)
,p_plug_template_id=>wwv_flow_imp.id(224451291078711117)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225513922984730246)
,p_plug_template_id=>wwv_flow_imp.id(224451291078711117)
,p_name=>'Sub Regions'

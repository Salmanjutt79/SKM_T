...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(224464765447711124)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225533291391730257)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225533758991730257)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225534229360730257)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225534760848730257)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225535281931730257)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225535770454730257)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225536286011730258)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225536755791730258)
,p_plug_template_id=>wwv_flow_imp.id(224464765447711124)
,p_name=>'Sub Regions'

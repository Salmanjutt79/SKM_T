...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(224454785120711119)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(224455017615711120)
,p_plug_template_id=>wwv_flow_imp.id(224454785120711119)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(224455337969711120)
,p_plug_template_id=>wwv_flow_imp.id(224454785120711119)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(224476450255711130)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(224476797419711130)
,p_plug_template_id=>wwv_flow_imp.id(224476450255711130)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(224477003165711130)
,p_plug_template_id=>wwv_flow_imp.id(224476450255711130)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(224477342985711130)
,p_plug_template_id=>wwv_flow_imp.id(224476450255711130)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(224382052022711054)
,p_theme_id=>101
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225320214933729968)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225320742931729969)
,p_page_template_id=>wwv_flow_imp.id(224382052022711054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225321292659729969)
,p_page_template_id=>wwv_flow_imp.id(224382052022711054)

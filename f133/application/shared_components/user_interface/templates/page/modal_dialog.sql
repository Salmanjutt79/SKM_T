...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(224400786639711085)
,p_theme_id=>101
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225375861176730015)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225376373106730015)
,p_page_template_id=>wwv_flow_imp.id(224400786639711085)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(225376884542730015)
,p_page_template_id=>wwv_flow_imp.id(224400786639711085)
